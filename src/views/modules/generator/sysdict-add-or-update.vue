<template>
  <el-dialog
    ...
    <el-form-item label="字典名字" prop="dictName">
      <el-input v-model="dataForm.dictName" placeholder="字典名字"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          dictName: [
            { required: true, message: '字典名字不能为空', trigger: 'blur' }
          ],
          dictValue: [
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.dictValue = data.sysDict.dictValue
